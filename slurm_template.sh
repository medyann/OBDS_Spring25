...
# fastqc  --nogroup --threads 2 --extract -o /project/lina4613/linux/3_analysis/1_fastqc /project/lina4613/linux/1_fastq/cd4_rep1_read1.fastq.gz /project/lina4613/linux/1_fastq/cd4_rep1_read2.fastq.gz

# hisat2-build /project/lina4613/linux/2_genome/Mus_musculus.GRCm39.dna.primary_assembly.fa grcm39

hisat2 --threads 8 \
	-x /project/shared/linux/5_rnaseq/hisat2_index/mm10 \
	-1 /project/lina4613/linux/1_fastq/cd4_rep1_read1.fastq.gz \
	-2 /project/lina4613/linux/1_fastq/cd4_rep1_read2.fastq.gz \
	--rna-strandness RF \
